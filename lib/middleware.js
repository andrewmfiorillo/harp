...
exports.debuggingLogs = function(req, rsp, next){
  ...
  console.log('projectPath: ' + req.projectPath);
  console.log('appPart: ' + req.appPart);
  console.log('urlPath: ' + req.urlPath);
  console.log('ignore_prefixes: ' + req.setup.config);
  next();
}
...
var rootIgnores = ['harp.json', '_harp.json', '_static'];
